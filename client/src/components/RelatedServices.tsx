...
const RELATED_MAP: Record<string, string[]> = {
  "rudraksha": ["/astrology", "/ai-kundli", "/puja", "/pandits", "/spiritual-essentials"],
  "incense": ["/puja", "/pandits", "/virtual-puja", "/spiritual-essentials", "/vastu-compass"],
  "puja": ["/pandits", "/puja", "/virtual-puja", "/donations", "/panchang-calendar", "/shop"],
  "idol": ["/puja", "/vastu-compass", "/pandits", "/donations", "/shop"],
  "wearable": ["/astrology", "/ai-kundli", "/ai-palm-reading", "/shop"],
  "havan": ["/puja", "/pandits", "/virtual-puja", "/shop", "/panchang-calendar"],
  "astrology": ["/ai-kundli", "/ai-palm-reading", "/ai-baby-names", "/pandits", "/puja", "/shop"],
  "pandit": ["/puja", "/virtual-puja", "/astrology", "/shop", "/donations", "/panchang-calendar"],
  ...
  "donation": ["/puja", "/pandits", "/virtual-puja", "/kathas", "/shop"],
  "katha": ["/donations", "/puja", "/pandits", "/panchang-calendar", "/shop"],
  "vastu": ["/astrology", "/ai-kundli", "/pandits", "/puja", "/shop"],
  "matrimony": ["/astrology", "/ai-kundli", "/pandits", "/puja"],
  "virtual-puja": ["/puja", "/pandits", "/donations", "/shop", "/panchang-calendar"],
  "panchang": ["/astrology", "/puja", "/pandits", "/ai-kundli", "/muhurat-finder"],
  "dashboard": ["/astrology", "/ai-kundli", "/puja", "/pandits", "/shop", "/kathas"],
  "shop": ["/spiritual-essentials", "/puja", "/pandits", "/astrology", "/compare"],
};
