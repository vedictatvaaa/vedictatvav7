...
function Router() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {!suppressGlobalPageChrome && <Footer />}
      {!suppressGlobalPageChrome && <MobileBottomNav />}
      {!suppressGlobalPageChrome && <PWAInstallBanner />}
      <AuthModal />
      {!suppressGlobalPageChrome && <DeferredWidgets />}
    </div>
  );
}
