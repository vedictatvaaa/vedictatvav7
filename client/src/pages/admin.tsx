...
const PanditProfileCompletionTab = safeLazy(() => import("./admin-tabs/PanditProfileCompletionTab"));
...
const TAB_COMPONENTS: Partial<Record<TabId, { preload: () => Promise<unknown> }>> = {
  ...
  "pandit-profile-completion": PanditProfileCompletionTab,
  mantras: MantrasTab,
        ...
        <div ref={contentScrollRef} className="flex-1 min-w-0 overflow-auto p-3 sm:p-6 lg:p-8" data-lenis-prevent>
          <div key={activeTab} className="w-full max-w-[1440px] animate-in fade-in duration-200">
            ...
            <Suspense fallback={fallback}>
              ...
              {activeTab === "pandit-profile-completion" && <PanditProfileCompletionTab />}
