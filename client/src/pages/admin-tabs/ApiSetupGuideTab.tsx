...
const GUIDES: ServiceGuide[] = [
  ...
  {
    id: "hostinger", label: "Hostinger SMTP (Email)", category: "communication", icon: "📧",
    description: "Sends transactional emails from admin@vedictatva.com through the durable outbox.",
    why: "Required for customer, Pandit, booking, recovery and order email notifications.",
    statusKey: "hostinger", docsUrl: "https://support.hostinger.com/en/articles/1583217-how-to-find-email-configuration-details", dbProviderId: "hostinger",
    steps: [
      { text: "Use the Hostinger mailbox admin@vedictatva.com. No external email provider or API key is required." },
      { text: "Use SSL/TLS on port 465 with smtp.hostinger.com." },
      { text: "Store the mailbox password only in Replit Secrets:", code: "SMTP_HOST = smtp.hostinger.com\nSMTP_PORT = 465\nSMTP_SECURE = true\nSMTP_USER = admin@vedictatva.com\nSMTP_PASSWORD = (mailbox password)\nMAIL_FROM = admin@vedictatva.com" },
    ],
    vars: [
      { name: "SMTP_HOST", description: "Hostinger SMTP host", required: true },
      { name: "SMTP_PORT", description: "465 for SSL/TLS", required: true },
      { name: "SMTP_SECURE", description: "true for SSL/TLS", required: true },
      { name: "SMTP_USER", description: "Hostinger mailbox username", required: true },
      { name: "SMTP_PASSWORD", description: "Hostinger mailbox password", required: true },
      { name: "MAIL_FROM", description: "Sender mailbox address", required: true },
    ],
  },
  {
