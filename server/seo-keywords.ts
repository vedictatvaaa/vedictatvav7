...
export const PUJA_PRIORITY_KEYWORDS: CuratedKeyword[] = [
  ...
  { keyword: "online vedic puja", targetPath: "/puja", intent: "transactional", priority: 10, cluster: "puja" },
  { keyword: "satyanarayan puja booking", targetPath: "/puja", intent: "transactional", priority: 10, cluster: "puja" },
  { keyword: "griha pravesh puja booking", targetPath: "/puja", intent: "transactional", priority: 10, cluster: "puja" },
  { keyword: "rudrabhishek puja online", targetPath: "/puja", intent: "transactional", priority: 10, cluster: "puja" },
  { keyword: "mahamrityunjaya jaap online", targetPath: "/puja", intent: "transactional", priority: 9, cluster: "puja" },
  { keyword: "navagraha shanti puja", targetPath: "/puja", intent: "transactional", priority: 9, cluster: "puja" },
  { keyword: "kaal sarp dosh puja", targetPath: "/puja", intent: "transactional", priority: 9, cluster: "puja" },
  { keyword: "vastu shanti puja online", targetPath: "/puja", intent: "transactional", priority: 9, cluster: "puja" },
  { keyword: "annaprashan samskar puja", targetPath: "/puja", intent: "transactional", priority: 8, cluster: "puja" },
  { keyword: "namkaran puja online", targetPath: "/puja", intent: "transactional", priority: 8, cluster: "puja" },
  { keyword: "mundan ceremony pandit", targetPath: "/puja", intent: "transactional", priority: 8, cluster: "puja" },
